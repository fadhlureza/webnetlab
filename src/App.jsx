    ...
    <div className="min-h-screen bg-primary text-text text-3xl font-bold font-sans">
      ...
      <div className="p-10 space-y-60">
        <div id="home" className="text-center scroll-mt-20">
          <h2 className="text-4xl font-bold text-secondary   mb-6">Welcome to Network Laboratory</h2>
          <p className="text-primary text-lg">
            Explore the various modules and enhance your knowledge in operating systems, data management, and database systems.
          </p>
        </div>
        <div id="os" className="bg-secondary border-2 border-accent rounded-lg p-6 flex justify-between items-center scroll-mt-20">
        ...
        <div id="dmj" className="bg-secondary border-2 border-accent rounded-lg p-6 flex justify-between items-center scroll-mt-20">
          <div>
        ...
        <div id="sbd" className="bg-secondary border-2 border-accent rounded-lg p-6 flex justify-between items-center scroll-mt-20">
        ...
        <div className="text-center mt-10">
          <img src={character} alt="Character" className="w-20 mx-auto mb-4" />
